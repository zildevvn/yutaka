...
$steps = [
    [
        ...
        'content' => 'まずは、事業内容や法人の現況、ご希望条件についてお伺いします。<br/> あわせて、案件化に必要となる資料をご提出いただきます。'
    ],
    [
        'title' => '案件化・買主様の募集',
        'image' => 'img-flow-002.png',
        'content' => 'ご提供いただいた情報を整理し、買主様の募集を開始します。<br/>この段階では、<b>会社が特定されないよう配慮した形</b>で情報を取り扱います。'
    ],
    [
    ...
    [
        ...
        'content' => '諸条件が整い次第、最終契約を締結します。<br/> 契約書の内容や手続きの進行についても、丁寧にサポートいたします。'
    ],
    [
        'title' => '譲渡・引継ぎ',
        'image' => 'img-flow-005.png',
        'content' => '契約内容に基づき、譲渡手続きを実行します。 <br/>案件によっては、引継ぎや移行のために3か月〜半年程度の移行期間を設ける場合もあります。'
    ],
];
?>
