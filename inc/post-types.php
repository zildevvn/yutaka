...
if (!function_exists('yutaka_create_custom_post_type')) {
	...
	function yutaka_create_custom_post_type()
	{
		...
		register_post_type('buyer_listing', array(
			'labels' => array(
				'name' => __('買収案件'),
				'singular_name' => __('買収案件'),
				'add_new' => __('新規追加'),
				'add_new_item' => __('買収案件を追加'),
				'edit_item' => __('買収案件を編集'),
				'new_item' => __('新しい買収案件'),
				'view_item' => __('買収案件を表示'),
				'search_items' => __('買収案件を検索'),
				'not_found' => __('買収案件が見つかりません'),
				'not_found_in_trash' => __('ゴミ箱に買収案件はありません'),
				'all_items' => __('すべての買収案件'),
				'menu_name' => __('買収案件'),
			),
			'label' => __('買収案件', 'yutaka'),
			'supports' => array('title', 'editor', 'thumbnail', 'revisions', 'page-attributes'),
